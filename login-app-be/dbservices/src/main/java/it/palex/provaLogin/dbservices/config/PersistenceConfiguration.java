package it.palex.provaLogin.dbservices.config;
...
@EnableJpaRepositories(
    basePackages = {"it.palex.provaLogin.dbaccess", "it.palex.provaLogin.dbservices"},
...
public class PersistenceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean sqlEntityManagerFactory(EntityManagerFactoryBuilder builder) {
         return  builder.dataSource(sqlDataSource())
        		 ...
        		 .packages("it.palex.provaLogin.dbaccess.entities").build();
     }
